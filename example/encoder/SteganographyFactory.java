...
public class SteganographyFactory {
    ...
    public static void main(String[] args) throws IOException {
        ...
        SteganographyFactory.getSteganography("example/MergeSorter.java","example/resources/merge.jpeg");
        SteganographyFactory.getSteganography("example/InsertSorter.java","example/resources/insert.jpeg");
